...
if __name__ == "__main__":
    ...
    commands_and_placeholders = [
        ...
        (["--help-prompt"], "%%%UTMS_HELP_PROMPT%%%", True),
        (["--dconv", "15:30:25"], "%%%UTMS_DCONV1%%%", True),
        (["--dconv", "1.2.205"], "%%%UTMS_DCONV2%%%", True),
        (["--conv", "5", "h"], "%%%UTMS_CONV_5H%%%", True),
        (["--conv", "1.25e7", "s"], "%%%UTMS_CONV_125S%%%", True),
        (["--conv", "1.25e7", "s", "h"], "%%%UTMS_CONV_125SH%%%", True),
        (["--unit"], "%%%UTMS_UNITS%%%", True),
        (["--unit", "h", "3", "5"], "%%%UTMS_UNITS_SHORT%%%", True),
        (["today"], "%%%UTMS_RESOLVE_TODAY%%%", True),
        (["beginning of world war 1"], "%%%UTMS_RESOLVE_WW2%%%", True),
        (["extinction of dinosaurs"], "%%%UTMS_RESOLVE_EXTINCTION%%%", True),
        (["fall of roman empire"], "%%%UTMS_RESOLVE_ROMAN%%%", True),
    ]
