...
Existing time systems—like the Gregorian calendar or the 24-hour
day—are rooted in arbitrary historical events and Earth-specific
...
3. **Customizable Reference Points**
   ...
   the future—be it the Unix epoch, the birth of civilization, or any
   other key event—making it adaptable to both personal and scientific
   contexts.
