...
class TimeStamp(Protocol):
    ...
    def __rfloordiv__(self, other: Union["TimeLength", "TimeLength", int, float, Decimal]) -> int: ...
...
class TimeLength(Protocol):
    ...
    def __radd__(self, other: Union["TimeStamp", "TimeLength", int, float, Decimal]) -> Union["DecimalTimeLength", "DecimalTimeStamp"]: ...
    def __iadd__(self, other: Union["TimeStamp", "TimeLength", int, float, Decimal]) -> Union["DecimalTimeLength", "DecimalTimeStamp"]: ...

    def __sub__(
        self, other: Union["TimeStamp", "TimeLength", int, float, Decimal]
    ) -> Union["DecimalTimeLength", "DecimalTimeStamp"]: ...
    def __rsub__(self, other: Union["TimeStamp", "TimeLength", int, float, Decimal]) -> Union["DecimalTimeLength", "DecimalTimeStamp"]: ...
    def __isub__(self, other: Union["TimeStamp", "TimeLength", int, float, Decimal]) -> Union["DecimalTimeLength", "DecimalTimeStamp"]: ...
