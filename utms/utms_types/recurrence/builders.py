...
class TimeBuilder:
    ...
    def at(self, *times: str) -> RecurrencePatternProtocol:
        ...
        self.pattern.add_constraint(time_constraint, f"At times: {', '.join(times)}")
        return self.pattern
    ...
    def between(self, start: str, end: str) -> RecurrencePatternProtocol:
        ...
        self.pattern.add_constraint(range_constraint, f"Between {start} and {end}")
        return self.pattern
...
class RecurrenceBuilder:
    ...
    def on(self, *days: str) -> TimeBuilder:
        ...
        self.pattern.add_constraint(weekday_constraint, f"On days: {', '.join(days)}")
