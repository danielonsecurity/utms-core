...
class CalendarUnit(Protocol):
    ...
    length: Union[Decimal, ResolvedValue]
    start: Union[Decimal, ResolvedValue]
    names: Optional[List[str]]
    timezone: Union[Decimal, ResolvedValue]
    offset: Union[int, ResolvedValue]
    index: Union[int, ResolvedValue]
...
class TimeUnit(Protocol):
    ...
    # Required attributes
    length: Union[Decimal, float]
    start: Union[Decimal, float]
    timezone: Union[Decimal, float]
