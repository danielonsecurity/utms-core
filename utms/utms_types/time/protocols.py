...
class TimeCalculator(Protocol):
    ...
    def diff_time(
        self, timestamp1: float, timestamp2: float, unit: str, timezone: Optional[float] = None
    ...
    def normalize_time(
        self, timestamp: float, unit: str, timezone: Optional[float] = None
    ) -> float:
    ...
    def split_time(
        self, timestamp: float, timezone: Optional[float] = None
