...
class MonthHeaderFormatter:
    ...
    def format_month_header(
        ...
        return (
            " " * padding_left + 
            ColorFormatter.blue(month_name) +
            " " * padding_right
        )

    def format_month_headers(
        self, 
...
class WeekRowFormatter:
    ...
    def format_month_week_days(
        ...
        for day_of_week in range(self.week_length):
            ...
            if (day_of_week < context.first_day_weekdays[month_idx] 
                and context.days[month_idx] == 1):
    ...
    def format_week_row(
        ...
        for i in range(len(context.month_starts)):
            ...
            week_days_str = self.format_month_week_days(
                ...
                i,
                day_context,
                is_current_month  # Pass it to format_month_week_days
            )
