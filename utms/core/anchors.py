...
# class AnchorManager(AnchorManagerProtocol, ManagerMixin):
...
#             if group_name in (hy_to_python(anchor.groups) or [])
#         ]
...
#     def _get_hy_nodes(self) -> List[HyNode]:
#         """Create HyNodes for anchors."""
#         return [anchor.to_hy() for anchor in sorted(self._anchors.values(), key=lambda a: a._value)]
