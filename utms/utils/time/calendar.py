...
from utms.core.protocols import CalendarUnitProtocol, TimeRange
...
def get_day_of_week(timestamp: float, week_unit: CalendarUnitProtocol, day_unit: CalendarUnitProtocol) -> int:
